                            ...
                            <div id="rev-slider1" class="rev_slider fullwidthabanner">
                                <ul>
                                    ...
                                    <li data-transition="random">
                                        <!-- Main Image -->
                                        <img src="http://rollthemes.com/html5/autoservice/assets/img/slider/slider-bg-1.jpg" alt="" data-bgposition="center center" data-no-retina>
                                        ...
                                        <div class="tp-caption tp-resizeme text-white"
                                            ...
                                            data-splitout="none" 
                                            data-responsive_offset="on">
                                            We provide top-notch service for import and domestic car repairs.  Servicing Brakes,<br> Exhaust, Tune Ups, Engine Repairs, Electrical and A.C Systems.
                                        </div>
                                    ...
                                    <li data-transition="random">
                                        <!-- Main Image -->
                                        <img src="http://rollthemes.com/html5/autoservice/assets/img/slider/slider-bg-2.jpg" alt="" data-bgposition="center center" data-no-retina>
                                    ...
                                    <li data-transition="random">
                                        <!-- Main Image -->
                                        <img src="http://rollthemes.com/html5/autoservice/assets/img/slider/slider-bg-3.jpg" alt="" data-bgposition="center center" data-no-retina>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-3">
                                        <div class="wprt-icon-box style-1 clearfix icon-top outline-type grey-outline align-center rounded-100 has-width w100">
                                            ...
                                            <h3 class="heading">
                                                <a target="_blank" href="#">AIR CONDITIONING</a>
                                            </h3>

                                            <p class="desc">We provide top-notch service for import and domestic car repairs. Servicing Brakes, Tune Ups, Engine Repairs</p>
                                    ...
                                    <div class="col-md-3">
                                        <div class="wprt-icon-box style-1 clearfix icon-top outline-type grey-outline align-center rounded-100 has-width w100">
                                            ...
                                            <h3 class="heading">
                                                <a target="_blank" href="#">ELECTRICAL SYSTEM</a>
                                            </h3>
                                    ...
                                    <div class="col-md-3">
                                        <div class="wprt-icon-box style-1 clearfix icon-top outline-type grey-outline align-center rounded-100 has-width w100">
                                            ...
                                            <h3 class="heading">
                                                <a target="_blank" href="#">BRAKE REPAIR</a>
                                            </h3>
                                    ...
                                    <div class="col-md-3">
                                        <div class="wprt-icon-box style-1 clearfix icon-top outline-type grey-outline align-center rounded-100 has-width w100">
                                            ...
                                            <h3 class="heading">
                                                <a target="_blank" href="#">AUTOMOTIVE FILTERS</a>
                                            </h3>
                            ...
                            <div class="container">
                                <div class="row">
                                    <div class="col-md-12">
                                        ...
                                        <div class="wprt-headings style-1 clearfix text-center">
                                            <h2 class="heading clearfix">OUR GALLERY</h2>
                                            <div class="sep clearfix"></div>
                                            <p class="sub-heading clearfix">Our professionals will perform diagnostic tests, fluid flush and fills, engine replacement, oil changes, and total vehicle overhauls.</p>
                                        </div><!-- /.wprt-headings -->
                                        ...
                                        <div class="wprt-gallery has-arrows arrow-center offsetcenter offset-v0" data-auto="false" data-column="3" data-column2="2" data-column3="1" data-gap="20"><div class="owl-carousel owl-theme">
                                        		...
                                        		<div class="inner">
                                        			<div class="hover-effect">
                                                		<div class="gallery-image">
                                                   			<img src="http://rollthemes.com/html5/autoservice/assets/img/works/work-1-640x640.jpg" alt="Image">
                                        				</div>

                                                        <div class="text">
                                                			<div class="icon">
                                                				<a class="zoom-popup" href="http://rollthemes.com/html5/autoservice/assets/img/works/work-1-full.jpg"><i class="rt-icon-zoom-in-2"></i></a>
                                        					</div>
                                            ...
                                            <div class="gallery-box">
                                                <div class="inner">
                                                    <div class="hover-effect">
                                                        <div class="gallery-image">
                                                            <img src="http://rollthemes.com/html5/autoservice/assets/img/works/work-2-640x640.jpg" alt="Image">
                                                        </div>

                                                        <div class="text">
                                                            <div class="icon">
                                                                <a class="zoom-popup" href="http://rollthemes.com/html5/autoservice/assets/img/works/work-2-full.jpg"><i class="rt-icon-zoom-in-2"></i></a>
                                                            </div>
                                            ...
                                            <div class="gallery-box">
                                                <div class="inner">
                                                    <div class="hover-effect">
                                                        <div class="gallery-image">
                                                            <img src="http://rollthemes.com/html5/autoservice/assets/img/works/work-3-640x640.jpg" alt="Image">
                                                        </div>

                                                        <div class="text">
                                                            <div class="icon">
                                                                <a class="zoom-popup" href="http://rollthemes.com/html5/autoservice/assets/img/works/work-3-full.jpg"><i class="rt-icon-zoom-in-2"></i></a>
                                                            </div>
                                            ...
                                            <div class="gallery-box">
                                                <div class="inner">
                                                    <div class="hover-effect">
                                                        <div class="gallery-image">
                                                            <img src="assets/img/works/work-4-640x640.jpg" alt="Image">
                                                        </div>

                                                        <div class="text">
                                                            <div class="icon">
                                                                <a class="zoom-popup" href="http://rollthemes.com/html5/autoservice/assets/img/works/work-4-full.jpg"><i class="rt-icon-zoom-in-2"></i></a>
                                                            </div>
                                            ...
                                            <div class="gallery-box">
                                                <div class="inner">
                                                    <div class="hover-effect">
                                                        <div class="gallery-image">
                                                            <img src="http://rollthemes.com/html5/autoservice/assets/img/works/work-5-640x640.jpg" alt="Image">
                                                        </div>
                                            ...
                                            <div class="gallery-box">
                                                <div class="inner">
                                                    <div class="hover-effect">
                                                        <div class="gallery-image">
                                                            <img src="assets/img/works/work-6-640x640.jpg" alt="Image">
                                                        </div>

                                                        <div class="text">
                                                            <div class="icon">
                                                                <a class="zoom-popup" href="http://rollthemes.com/html5/autoservice/assets/img/works/work-6-full.jpg"><i class="rt-icon-zoom-in-2"></i></a>
                                                            </div>
                                        ...
                                        <div class="wprt-animation-block" data-animate="fadeInUpSmall" data-duration="1s" data-delay="0s" data-position="90%">
                                            <div class="wprt-icon-box style-2 clearfix icon-left">
                                                <div class="image-wrap">
                                                    <img src="http://rollthemes.com/html5/autoservice/assets/img/ase.png" alt="Image">
                                            	</div>
                        ...
                        <div class="row-about">
                            <div class="container">
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                    	<img src="http://rollthemes.com/html5/autoservice/assets/img/about.jpg" alt="Image">
									...
									<div class="col-md-6">
                                        <div class="wprt-headings style-1 clearfix">
                                            <h2 class="heading clearfix">LONG TERM WARRANTIES AND COMPETITIVE PRICES</h2>
                                            <div class="sep clearfix"></div>
                                        </div><!-- /.wprt-headings -->

                                        <div class="wprt-spacer clearfix" data-desktop="20" data-mobi="20" data-smobi="20"></div>

                                        <p>Why do we consider ourselves to be the best car garage? It’s simple, really. We know that honesty and transparency, coupled with reliable and friendly customer service, is what really builds customer trust.</p>
                                        <p>Trust the experts at our AutoService Shop for quality tune-ups. Our professionals will perform diagnostic tests, fluid flush and fills, engine replacement, oil changes, and total vehicle overhauls. We offer competitive.</p>

                                        <div class="wprt-spacer clearfix" data-desktop="20" data-mobi="10" data-smobi="10"></div>

                                        <a href="#" class="wprt-button solid accent">
                                    		<span>SEE ALL OUR OFFERS </span>
                                    	</a>
                                    </div><!-- /.col-md-6 -->
                                        ...
                                        <div class="wprt-carousel-box has-bullets bullet-circle" data-auto="true" data-loop="false" data-gap="25" data-column="3" data-column2="2" data-column3="1"><div class="owl-carousel owl-theme">
                                            <div class="wprt-testimonials style-1 clearfix image-circle">
                                                <div class="item">
                                                    <div class="inner">
                                                        <div class="thumb">
                                                            <img src="http://rollthemes.com/html5/autoservice/assets/img/testimonials/customer-1.png" alt="Image">
                                                        </div>
                                            ...
                                            <div class="wprt-testimonials style-1 clearfix image-circle">
                                                <div class="item">
                                                    <div class="inner">
                                                        <div class="thumb">
                                                            <img src="http://rollthemes.com/html5/autoservice/assets/img/testimonials/customer-2.png" alt="Image">
                                                        </div>
                                            ...
                                            <div class="wprt-testimonials style-1 clearfix image-circle">
                                                <div class="item">
                                                    <div class="inner">
                                                        <div class="thumb">
                                                            <img src="http://rollthemes.com/html5/autoservice/assets/img/testimonials/customer-3.png" alt="Image">
                                                        </div>
                                        ...
                                        <div class="wprt-partner style-1 arrow-center offset30 offset-v0 has-arrows" data-auto="false" data-loop="false" data-column="5" data-column2="3" data-column3="2" data-gap="60"><div class="owl-carousel owl-theme">
                                            <div class="partner-item clearfix">
                                                <div class="inner">
                                                	<a target="_blank" href="#">
                                                		<div class="thumb">
                                                            <img src="http://rollthemes.com/html5/autoservice/assets/img/partners/logo-1.png" alt="Image">
                                                		</div>
                                                	</a>
                                                </div>
                                            </div>
                                            ...
                                            <div class="partner-item clearfix">
                                                <div class="inner">
                                                    <a target="_blank" href="#">
                                                        <div class="thumb">
                                                            <img src="http://rollthemes.com/html5/autoservice/assets/img/partners/logo-2.png" alt="Image">
                                                        </div>
                                                    </a>
                                                </div>
                                            </div>
                                            ...
                                            <div class="partner-item clearfix">
                                                <div class="inner">
                                                    <a target="_blank" href="#">
                                                        <div class="thumb">
                                                            <img src="http://rollthemes.com/html5/autoservice/assets/img/partners/logo-3.png" alt="Image">
                                                        </div>
                                                    </a>
                                                </div>
                                            </div>
                                            ...
                                            <div class="partner-item clearfix">
                                                <div class="inner">
                                                    <a target="_blank" href="#">
                                                        <div class="thumb">
                                                            <img src="http://rollthemes.com/html5/autoservice/assets/img/partners/logo-4.png" alt="Image">
                                                        </div>
                                                    </a>
                                                </div>
                                            </div>
                                            ...
                                            <div class="partner-item clearfix">
                                                <div class="inner">
                                                    <a target="_blank" href="#">
                                                        <div class="thumb">
                                                            <img src="http://rollthemes.com/html5/autoservice/assets/img/partners/logo-5.png" alt="Image">
                                                        </div>
                                                    </a>
                                                </div>
                                            </div>
                                            ...
                                            <div class="partner-item clearfix">
                                                <div class="inner">
                                                    <a target="_blank" href="#">
                                                        <div class="thumb">
                                                            <img src="http://rollthemes.com/html5/autoservice/assets/img/partners/logo-6.png" alt="Image">
                                                        </div>
                                                    </a>
                                                </div>
                                            </div>
                                            ...
                                            <div class="partner-item clearfix">
                                                <div class="inner">
                                                    <a target="_blank" href="#">
                                                        <div class="thumb">
                                                            <img src="http://rollthemes.com/html5/autoservice/assets/img/partners/logo-7.png" alt="Image">
                                                        </div>
                                                    </a>
                                                </div>
                                            </div>
                                            ...
                                            <div class="partner-item clearfix">
                                                <div class="inner">
                                                    <a target="_blank" href="#">
                                                        <div class="thumb">
                                                            <img src="http://rollthemes.com/html5/autoservice/assets/img/partners/logo-8.png" alt="Image">
                                                        </div>
                                                    </a>
                                                </div>
                                            </div>
